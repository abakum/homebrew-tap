class Crocson < Formula
  ...
  url "https://github.com/abakum/crocson/releases/download/v1.11.65/crocson.tar.xz"
  sha256 "0125493d338f3d15c421dbb8e0a8f45f25181005e3e1aa1157b097f1466f9035"
  license "ISC"
  ...
  test do
    assert_path_exists bin/"crocson"
  end
end
